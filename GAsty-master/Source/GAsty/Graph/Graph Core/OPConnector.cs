...
namespace Oasis
{
    public class OPConnector : NodeGraphConnector
    {
        ...
        public OPConnector(string p_Name, NodeGraphNode p_parent, ConnectorType p_ConnectorType, int p_ConnectorIndex, string p_NodeGraphDataTypeName)
